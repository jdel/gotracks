...
[v0.4.0 release](https://github.com/jdel/gotracks/releases/tag/v0.4.0), extract it,
and run:
...
```bash
go install github.com/jdel/gotracks@v0.4.0
```
...
The built SPA is committed, so `go install github.com/jdel/gotracks@v0.4.0` also
